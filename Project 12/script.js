...
// let itema = document.querySelector("a").getAttribute("href")
// console.log(itema)

// let item_p = document.querySelector("p")
// let item_pa = item_p.getAttribute("id")

// console.log(item_pa);

// let item = document.querySelector("div")

// item.setAttribute("id", "item-2")
...
// function addAttr() {
//     img1.setAttribute("src", "./images/img-2.jpg")
...
//  button.addEventListener("click", addAttr)
// img1.setAttribute("src", "./images/img-1.jpg")
